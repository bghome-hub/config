...
BEGIN
    ...
    BEGIN TRY
        ...
        /* CORRECTED: Removed @I_vBatchNumber. Added @I_vInc_Dec = 1 */
        ...
        BEGIN
            ...
            /* ----------------------------------------------------------------------------------
               CORRECTED eCONNECT PARAMETERS:
               1. @I_vDEBITAMT  (No N)
               2. @I_vCRDTAMNT  (With N)
               3. @I_vDSCRIPTN  (Line Description)
               4. @I_vINTERID   (Destination Company DB)
               ---------------------------------------------------------------------------------- */
            ...
            BEGIN
                 /* Capture the exact error string from eConnect */
