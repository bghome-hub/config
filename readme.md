...
CREATE   PROCEDURE [dbo].[usp_IA_Job_Report] (
...
BEGIN
    ...
    CREATE TABLE #JobReport (
        JobReportID               INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
        JobID                       UNIQUEIDENTIFIER,
        runid                       UNIQUEIDENTIFIER,
    ...
    SELECT * FROM #JobReport ORDER BY CompanyA, BatchID, Account;
...
CREATE TABLE [dbo].[IA_Fiscal_Period] (
    [PeriodID]   int PRIMARY KEY,
    [PeriodMonth]   VARCHAR (129),
